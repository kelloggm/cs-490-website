...
for more about the Honors section.

Honors students also write two [Honors Reflection Essays](../projects/honors-essays.html), which are
graded as part of the individually-graded component of the project (see "Summary of Project Grading", above).
...
Talk to your mentor!
Given that you will have a team of three or four and most of the semester to work, we expect that the feature that you propose will be
at least as substantial as one of the features that already exists in Covey.Town today (for example, the conversation areas or the viewing areas).
This is a higher bar than in previous semesters, when the project ran for only about half of the term.
Honors teams should expect to clear a higher bar still for ambition, polish, and scalability (see "Honors Projects", above).
