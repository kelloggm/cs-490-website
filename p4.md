...
parent: Project
nav_order: 4
due_date: "~~Friday, 13~~ Sunday 22 March 2026, 11:59PM AoE."
...
- Learn how to collaborate with LLMs to generate backend code, while refining and debugging the output, with a real frontend (your P3 submission).  
...
Please turn in a single document that contains these parts:  
  ...
  1. Provide the necessary commands to get the frontend & backend servers up & running. We will test the apps using these commands.
