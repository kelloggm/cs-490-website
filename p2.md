...
permalink: /projects/p2.html
parent: Project
nav_order: 2
due_date: "Wednesday, 18 February 2026, 11:59PM AoE."
...
Choose **3 user stories** from your user stories in P1 and have an LLM expand them into dev specs. Your team must produce a spec for each of the 3 that includes the following sections with enough detail that you (or someone else) could implement it:
  ...
  2. Architecture Diagram
      1. Specify where the components run (e.g., client, server, cloud, etc.). 
      2. Specify which information flows between components.
  3. Class Diagram
  4. List of Classes
  5. State Diagrams
  6. Flow Chart
...
1. The three user stories from P1 that you chose to expand into a dev spec, listed at the beginning of your document. 
    1. Add the user stories to GitHub and turn in the links to each user story.
3. First dev spec document containing all the sections above. Each section should have rationale to justify your decisions. After each section, copy-paste the chat log showing your prompts and the LLM’s responses.
    1. Commit this dev spec into your GitHub repo and turn in the link to it.
5. Second dev spec document containing all the sections above. Each section should have rationale to justify your decisions. After each section, copy-paste the chat log showing your prompts and the LLM’s responses.
    1. Commit this dev spec into your GitHub repo and turn in the link to it.
7. Third dev spec document (this is the one dependent on one of the previous two user stories) containing all the sections above. Each section should have rationale to justify your decisions. After each section, copy-paste the chat log showing your prompts and the LLM’s responses. 
    1. Add an explanation of how the other user story's dev spec was modified to accommodate this user story's features. 
    1. Commit this dev spec into your GitHub repo and turn in the link to it.
10. A 1–2 paragraph reflection on **how useful the LLM was in helping you create the dev specs**, and **what parts required the most human correction/reprompting**.  