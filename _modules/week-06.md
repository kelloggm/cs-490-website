...
: [Abstract Interpretation (2)](../assets/lecture-ai2.pdf)
  : **Mandatory reading**: Ernst's [_Notes on Program Analysis_](https://homes.cs.washington.edu/~mernst/pubs/program-analysis-book.pdf), 2.13 through 2.20
    ...
    **Optional reading**: Cousot and Cousot's [Abstract interpretation: a unified lattice model for static analysis of programs by construction or approximation of fixpoints](../assets/cousot-77.pdf) (note that this is an old, tough to read paper. [Ernst] 2.22 has some notes to help you make sense of the paper.)
