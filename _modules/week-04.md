...
: Requirements Engineering: Creating Dev Specs
  : **Mandatory reading**: [Development Spec Guidelines](../assets/dev-spec-guidelines.pdf)
    ...
    **Special topics reading**: [Aligning Requirement for Large Language Model's Code Generation](https://arxiv.org/abs/2509.01313)

Before class Feb 11
  : **[Reflection essay](../assignments/a2) on requirements gathering w/ LLMs due**{: .label .label-red }
